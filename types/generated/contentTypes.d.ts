...
export interface ApiBaseSkillBaseSkill extends Struct.CollectionTypeSchema {
  collectionName: 'base_skills';
  info: {
    description: 'Pre-defined skill types that users can offer';
    displayName: 'Base Skill';
    pluralName: 'base-skills';
    singularName: 'base-skill';
  };
  options: {
    draftAndPublish: false;
    increments: true;
...
export interface ApiBlockBlock extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Block - stores user-to-user blocking relationships';
    displayName: 'Block';
    name: 'block';
    pluralName: 'blocks';
    singularName: 'block';
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Category - skill categories available in the platform';
...
export interface ApiChatParticipantChatParticipant
  extends Struct.CollectionTypeSchema {
  collectionName: 'chat_participants';
  info: {
    description: 'ChatParticipant - represents users participating in a chat';
    displayName: 'Chat Participant';
    name: 'chat-participant';
    pluralName: 'chat-participants';
    singularName: 'chat-participant';
  };
  options: {
    draftAndPublish: false;
    increments: true;
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chat-participant.chat-participant'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chat - represents a chat session between users';
    displayName: 'Chat';
    name: 'chat';
    pluralName: 'chats';
    singularName: 'chat';
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Message - stores individual messages exchanged in a chat';
    displayName: 'Message';
    name: 'message';
    pluralName: 'messages';
...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User profile - stores extended profile information';
    displayName: 'Profile';
    name: 'profile';
    pluralName: 'profiles';
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Report - stores reports submitted by users for inappropriate behavior';
    displayName: 'Report';
    name: 'report';
    pluralName: 'reports';
    singularName: 'report';
  ...
  attributes: {
    bookingRequest: Schema.Attribute.Relation<
      'manyToOne',
    ...
    reportedUser: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Review - stores ratings and reviews submitted by users';
    displayName: 'Review';
    name: 'review';
    pluralName: 'reviews';
    singularName: 'review';
...
export interface ApiRoleRole extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Role - system roles for access control and permissions';
    displayName: 'Role';
    name: 'role';
    pluralName: 'roles';
    singularName: 'role';
...
export interface ApiServiceRequestServiceRequest
  ...
  info: {
    description: 'ServiceRequest - stores booking or service requests between users';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reports: Schema.Attribute.Relation<'oneToMany', 'api::report.report'>;
    requestedTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ...
    serviceLocation: Schema.Attribute.Text;
    serviceMode: Schema.Attribute.Enumeration<['REMOTE', 'ONSITE', 'HYBRID']> &
      Schema.Attribute.Required;
    skill: Schema.Attribute.Relation<'manyToOne', 'api::skill.skill'>;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Skill - represents a skill offered by a user';
    displayName: 'Skill';
    name: 'skill';
    pluralName: 'skills';
    singularName: 'skill';
  ...
  attributes: {
    baseSkill: Schema.Attribute.Relation<
      'manyToOne',
      'api::base-skill.base-skill'
    >;
    category: Schema.Attribute.Relation<'manyToOne', 'api::category.category'>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::skill.skill'> &
      Schema.Attribute.Private;
    proposedBaseSkillName: Schema.Attribute.String;
    proposedCategoryName: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    rejectionReason: Schema.Attribute.Text;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    serviceRequests: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-request.service-request'
    >;
    status: Schema.Attribute.Enumeration<['pending', 'approved', 'rejected']> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::base-skill.base-skill': ApiBaseSkillBaseSkill;
      'api::block.block': ApiBlockBlock;
      'api::category.category': ApiCategoryCategory;
      'api::chat-participant.chat-participant': ApiChatParticipantChatParticipant;
